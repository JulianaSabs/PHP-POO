...
echo "Salário {$laercio->vencimento($laercio->salario)} <br> ";
echo "Salário {$maria->vencimento($maria->totalVenda*$maria->taxaComissao)} <br> ";

echo "Salário {$nicolas->vencimento($nicolas->precoHoras*$nicolas->horasTrabalhadas)} <br> ";
